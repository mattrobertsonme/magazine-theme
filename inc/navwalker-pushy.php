 ...
 * WP Pushy Navwalker
 *
 * @package WP-Pushy-Navwalker
 */

/**
 * Class Name: WP_Pushy_Navwalker
 * Plugin Name: WP Pushy Navwalker
...
if ( ! class_exists( 'WP_Pushy_Navwalker' ) ) {
	/**
	 * WP_Pushy_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class WP_Pushy_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				if ( $args->has_children ) {
					$class_names .= ' pushy-submenu pushy-submenu-closed';
				}
