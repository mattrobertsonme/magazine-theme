	...
	<main class="push">
        ...
        <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				<label>
					...
					<input type="search" class="search-field" placeholder="Type text and hit enter" value="" name="s">
				</label>
		...
		if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<h1 class="page-title"><?php
					...
					printf( esc_html__( 'Search Results for: %s', 'magazine-theme-v1' ), '<span>' . get_search_query() . '</span>' );
				?></h1>
			</header><!-- .page-header -->
